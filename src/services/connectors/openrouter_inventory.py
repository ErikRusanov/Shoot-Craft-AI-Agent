...
_SYSTEM_PROMPT = (
    ...
    "short, concrete noun phrases. Fields: pose (body orientation, posture, arm and "
    "hand placement), hands (visibility, gesture, held objects), accessories (each "
    "item with its placement, e.g. 'wedding ring on the right hand', 'white earbud "
    "in the left ear'), clothing (garment, color, fit, neckline), hair, facial_hair, "
    "framing (crop, camera distance and angle), lighting (light direction, quality, "
    "overall color grade), background (a one-sentence summary). Do not describe "
    "facial geometry or identity — only what sits on or around the person."
)
